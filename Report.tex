...
\includegraphics[scale=0.3]{AM_RX_1_outputs_Trinagle.png}
...
\includegraphics[scale=0.5]{Output Waveforms + 4pi 4.jpg}
...
\includegraphics[scale=0.5]{frequncy change Output Waveforms.jpg}
